...
const allowed = new Set<IxcReadOperation>(["testConnection","findCustomer","getCustomer","listContracts","getPlan","listInvoices","listPayments","listServiceOrders","getConnection","getCity"]);
